...
const utils = {
    ...
    onExtractArchive() {
        ...
        let holidays = ["01 01 2020", "01 01 2021", "09 05 2021", "12 25 2021", "12 26 2021",
            ...
            "12 25 2025", "12 26 2025", "01 01 2026", "01 02 2026", "04 12 2026", "04 13 2026"
        ];
        let holidaysDays = [];
...
function archiveView(event) {
    ...
    document.getElementById("button").removeEventListener("click", utils.onExtractArchive);
    document.getElementById("button").addEventListener("click", utils.onExtractArchive);
}
